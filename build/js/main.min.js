...
var navItems = document.querySelectorAll('.main-nav__link-js');
...
document.addEventListener('click', function (e) {
  var withinBoundaries = e.composedPath().includes(header);
...
catalogItems.forEach(function (catalogItem) {
  catalogItem.addEventListener('focus', function (event) {// console.log(event.currentTarget);
